...
JNIEXPORT void JNICALL
Java_cn_wsgwz_gravity_util_NativeUtils_exec(JNIEnv *env, jclass type, jstring cmdStr_) {
...
JNIEXPORT void JNICALL
Java_cn_wsgwz_gravity_util_NativeUtils_execs(JNIEnv *env, jclass type, jstring cmdStr_) {
    const char *cmdStr = env->GetStringUTFChars(cmdStr_, 0);
...
Java_cn_wsgwz_gravity_util_NativeUtils_getConfigs(JNIEnv *env, jclass type, jstring typeStr_) {
