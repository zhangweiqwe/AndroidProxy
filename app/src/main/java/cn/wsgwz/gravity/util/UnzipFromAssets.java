...
public class UnzipFromAssets {
    ...
    public static  void toSdcard(Context context,String assetName, String outputDirectory,boolean isReWrite) throws IOException {
        // 创建解压目标目录
        ...
        FileOutputStream fileOutputStream = new FileOutputStream(new File(file1.getAbsolutePath()+"/"+assetName));
